    ...
    return (<>
        <section className="relative h-[620px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
                ...
                >
                    {t("service.hero.heading.part1")}{" "}
                    <span className="text-[#E10600]">{t("service.hero.heading.part2")}</span>
                </motion.h1>
                ...
                >
                    <Link href="/services">
                        ...
                        >
                            {t("service.hero.buttons.explore")}
                        </Button>
                    </Link>
                    <Link href="/contact">
                        <Button
        ...
        <motion.p
            ...
            className=" text-red-500 font-semibold text-lg text-center mb-20 mt-20"
        >
        {t("service.hero.notfound")}
        </motion.p>
        </>
    );
}
